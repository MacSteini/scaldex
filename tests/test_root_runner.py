...
class RootRunnerTests(unittest.TestCase):
    def test_help_text_explains_common_enduser_flow(self) -> None:
        ...
        self.assertIn("For Codex-assisted follow-up, provide scaldex-run/CODEX_HANDOFF.md and subject/", help_text)
    ...
    def test_print_result_replays_existing_result_without_subject_or_api_key(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("- Provide with: the measured subject/ package and a clear task.", output.getvalue())
